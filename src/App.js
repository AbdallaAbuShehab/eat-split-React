  ...
  return (
    <div className="app">
      <div className="sidebar">
        ...
        {showAddFrnd ? <FormAddFriend onAddFriend={handelAddFriend} /> : ""}

        <Button onClick={handlerShowAdd}>
          {showAddFrnd ? "Close" : "Add freind"}
        </Button>
      </div>
...
function FormSplitBill({ selectedFriend, onSplitBill }) {
  ...
  return (
    <form className="form-split-bill" on onSubmit={handlerSubmit}>
      ...
      <input
        ...
        value={paidByUser}
        onChange={(e) =>
          paidByUser < bill ? setPaidByUser(+e.target.value) : paidByUser
        }
      />
